...
\begin{tikzpicture}[ipe stylesheet]
  ...
  % (144, 784) rectangle (160, 752);
   ...
   (152.9, 767) circle[radius=8];
      \node[ipe node]
   at (133, 790) {$\vec z = \vec\mu + \mat R\vec \epsilon$};
  \node[ipe node]
  ...
  \draw[ipe pen heavier, ->]
    (128, 744)
     -- (144, 768);
  \node[ipe node]
  at (149, 720) {$\vec \epsilon$};
  \node[ipe node]
  at (165, 720) {$\vec \epsilon\sim\gauss{\vec 0}{\mat I}$};
  \draw[ipe pen heavier]
    (152, 722.1445) circle[radius=8];
  \draw[ipe pen heavier, ->]
    (152.9821, 730.084)
     -- (152.9821, 759);
  \draw[ipe pen heavier, ->]
  ...
  \node[ipe node]
     at (194.853, 765.509) {$\vec\mu_{\vec\psi}, \mat\Sigma_{\vec\psi}$};
  \node[ipe node]
     at (16, 765.856) {$\vec x$};
  \node[ipe node]
